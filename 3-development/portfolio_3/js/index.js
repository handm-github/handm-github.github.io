 ...
 const characterData2 = [
  {
    ...
    description: `지구정복을 위해 지구에 왔다고 했으나, 사실 잠복근무를 위한 컨셉이었다.
            ...
            <br>성격은 나름 선량하고 순진한 외계인이지만,엄청난 폐급, 고문관 경찰이자 트롤러다. 
            &nbsp; 다만 우주경찰이 아닌 짐벤져스의 동맹으로서는 아주 유능한 모습을 보여주었다. 새대갈 구출작전의 참모 역할을 했을 뿐만 아니라 경비들과 김과장을 제압하고 직접적으로 새대갈을 구출해내기까지 했다.
  ...
  },
  {
    ...
    <br>
   <p>우주경찰들 편에서는 이견의 여지가 없는 폐급이자 악인으로 비토레텔 별의 김춘식을 노예로 부려먹는 것만 봐도 인성이 더럽다는걸 알수있다.</p>`
  },
  {
    name: '김춘식',
